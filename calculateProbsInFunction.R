...
# I guess some of you may prefer to use col representing one sample, which is
...
#======================== refract the code above into a function =====================
...
# ready to try your freshly baked function
getHeadProb(10)
getHeadProb(15)
...
# so the take-home message is, if you want to make a new function, try to 
# lay out your code first, and see if there is any reusable chunk of code,
# if there is, look for what argument it requires, then you can change it to 
# a function
